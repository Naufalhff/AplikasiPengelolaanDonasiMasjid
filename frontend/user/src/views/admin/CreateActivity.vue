    ...
    <div class="row justify-content-center">
      <div class="col-xl-8 col-lg-10 col-md-12">
        ...
        <form @submit.prevent="validateForm" novalidate>
          ...
          <div class="mb-4">
            <label for="activityImage" class="form-label"
          ...
          <div class="mb-4">
            <label for="qrisImage" class="form-label"
              >Upload QR Code Qris</label
            >
            <input
              type="file"
              class="form-control form-control-lg"
          ...
          <div class="d-flex justify-content-between mt-4">
            <button @click="cancel" class="btn btn-outline-secondary btn-lg">
              Batalkan
            </button>
...
export default {
  ...
  methods: {
    ...
    onQRISImageChange(event) {
      ...
      if (file) {
        if (!["image/jpg", "image/jpeg", "image/png"].includes(file.type)) {
          this.errors.qrisImage =
            "QR Code harus berupa file gambar (jpg, jpeg, png).";
        } else if (file.size > 5 * 1024 * 1024) {
    ...
    validateForm() {
      ...
      const imageFile = this.form.image;
      const qrisFile = this.form.qrisImage;
      ...
      if (!this.form.targetAmount) {
        ...
        this.errors.targetAmount =
          "Target terkumpul tidak boleh lebih dari 15 digit.";
      }
    ...
    async submitForm() {
      ...
      try {
        const response = await axios.post(
          "http://localhost:8000/api/buat-kegiatan",
          formData,
          {
            headers: {
