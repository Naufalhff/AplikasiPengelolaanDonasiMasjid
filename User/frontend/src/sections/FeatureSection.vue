  ...
  <div id="features" class="container mx-auto px-5">
    <section class="py-16">
      <div class="w-4/5 md:w-3/5 mx-auto">
        ...
        >
          Aplikasi Pengelolaan Donasi Masjid hadir untuk mempermudah para
          donatur dalam menyalurkan infak, zakat, dan sumbangan lainnya secara
          digital dengan transparansi dan amanah.
        </p>
      </div>
