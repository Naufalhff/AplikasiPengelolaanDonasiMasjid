  ...
  <div class="container mx-auto px-5 overflow-x-hidden lg:overflow-x-visible">
    <section class="grid grid-cols-none lg:grid-cols-2 pb-16 pt-8 items-center">
      <div class="lg:w-5/6 order-2 lg:order-none">
        ...
        >
          Pengelolaaan Donasi Masjid
        </h1>
        <p
          class="lg:text-xl mt-10 font-theme-content text-theme-grayish-blue text-center lg:text-left"
        >
          Melalui Donasi Anda, Kita Bersama Menghadirkan Kebaikan untuk Sesama.
          Setiap kontribusi yang Anda berikan membantu mereka yang membutuhkan
          dan turut membangun masyarakat yang lebih kuat dan peduli.
        </p>
        <div class="flex justify-center lg:justify-start mt-10">
          <LinkButton btn-type="primary" link="#download-section"
            >Donasi Sekarang!</LinkButton
          >
        </div>
      </div>
      <div>
        <!-- class="relative order-1 lg:order-none mb-20 lg:mt-0 lg:mb-0 lg:-mr-10" -->
        <img class="z-10 w-full h-auto rounded-lg" src="/images/Mesjid.jpg" />
        <div
