    ...
    <header class="flex justify-between py-12 items-center">
      ...
      <nav class="flex justify-end flex-col md:flex-row">
        ...
        >
          ...
          >
            <a href="#features" v-smooth-scroll>Beranda</a>
          </li>
          <li
            class="uppercase hover:text-theme-secondary transition duration-200"
          >
            <a href="#faq" v-smooth-scroll>Tentang Kami</a>
          </li>
          <li
            class="uppercase hover:text-theme-secondary transition duration-200"
          >
            <a href="#subscribe" v-smooth-scroll>Kegiatan</a>
          </li>
          <li
          ...
          >
            <a href="#download-section" v-smooth-scroll>Donasi</a>
          </li>
        </ul>
      </nav>
    </header>
